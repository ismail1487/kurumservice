...
{
    public class TestServerRequestHelper3
    {
        protected TestServerRequestHelper3()
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static IRequestHelper CreateHelper(TestLoginUserManager3 manager = null)
        {
            var _server = new TestServer(new WebHostBuilder()
                ...
                .ConfigureTestServices(services =>
                {
                    if (manager == null)
                    {
                        ...
                        services.AddTransient<ILoginUser, TestLoginUserManager3>();
                    }
                })
                .UseStartup<Startup>()
            ...
            if (_helper._headers == null)
            {
                ...
                {
                    EmailOrUserName = "meleksen7@gmail.com",
                    Password = "123456aA!"
                });
    ...
    /// </summary>
    public class TestLoginUserManager3 : ILoginUser
    {
        /// <summary>
        /// Test servisi için default test kullanıcısı yapıcı metodu
        /// </summary>
        public TestLoginUserManager3()
        {
        }
        ...
        /// Test servisi için default test kullanıcısı yapıcı metodu
        /// </summary>
        public TestLoginUserManager3(int KurumID, int KisiID)
        {
